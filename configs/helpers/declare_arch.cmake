...
macro(declare_arch)
  ...
  if(${DECLARE_ARCH_ARCH} STREQUAL rv64)
    ...
    set(CONFIG_ARCH_TASK_OFFSET 48)
    ...
    elseif(${CONFIG_MMU} STREQUAL "sv48")
      ...
      set(MAX_PAGE_SIZE 0x8000000000)
    endif()
    ...
    math(EXPR CONFIG_GLOBAL_SPACE_SIZE "${CONFIG_CAPABILITY_CLASS_SPACE_BASE} + ${CONFIG_CAPABILITY_CLASS_SPACE_SIZE} - ${CONFIG_KERNEL_SPACE_BASE}" OUTPUT_FORMAT HEXADECIMAL)
    math(EXPR CONFIG_GLOBAL_SPACE_SIZE "(${CONFIG_GLOBAL_SPACE_SIZE} + ${MAX_PAGE_SIZE} - 1) / ${MAX_PAGE_SIZE} * ${MAX_PAGE_SIZE}" OUTPUT_FORMAT HEXADECIMAL)

    math(EXPR CONFIG_CAPABILITY_LIST_SPACE_BASE "${CONFIG_GLOBAL_SPACE_BASE} + ${CONFIG_GLOBAL_SPACE_SIZE}" OUTPUT_FORMAT HEXADECIMAL)
