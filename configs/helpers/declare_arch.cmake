...
macro(declare_arch)
  ...
  if(${DECLARE_ARCH_ARCH} STREQUAL rv64)
    ...
    math(EXPR CONFIG_CAPABILITY_SPACE_SIZE "0x200000" OUTPUT_FORMAT HEXADECIMAL)

    math(EXPR CONFIG_ACTUAL_VIRTUAL_SPACE_SIZE "${CONFIG_CAPABILITY_SPACE_BASE} + ${CONFIG_CAPABILITY_SPACE_SIZE}" OUTPUT_FORMAT HEXADECIMAL)
